...
Cb_elm = circuit.C(1, "Vbat", "Cbout", c1_max@u_F)
Rb_elm = circuit.R(0, "Cbout", circuit.gnd, r0_max@u_Ω)
...
R0_elm = circuit.R(1, "Res_node", 'Vl', r0_max@u_Ω)

C1_elm = circuit.C(2, 1, "Res_node", c1_max@u_F)
R1_elm = circuit.R(2, 1, "Res_node", r1_max@u_Ω)

C2_elm = circuit.C(2, 'Cbout', 1, c2_max@u_F)
R2_elm = circuit.R(2, 'Cbout', 1, r2_max@u_Ω)
